...
const DonationPopup = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#0000008f] top-0 left-0 right-0 bottom-0 h-screen bg-opacity-50">
      <div className="md:bg-mobile_color bg-white flex justify-center items-center flex-col md:text-white text-dark_bg p-8 py-24 border border-white rounded-3xl w-[90%] md:w-[30%]">
            <h1 className='text-4xl mb-2 text-black md:text-white font-bold'>"Congratulations!"</h1>
            <p className='text-2xl font-bold text-center'> You have donated $1 successfully.</p>
