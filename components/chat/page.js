...
const ChatPage = () => {
  return (
    <div className="w-full bg-active_bg p-4 relative text-white rounded-md flex flex-col justify-between h-full ">
      ...
      <div>
        <div className="flex items-center max-w-lg gap-2 px-2 border-l-2 border-[#CB7474]">
          ...
          />
          <div>
            <p className="text-sm bg-white rounded-lg p-1 text-bg mt-1">
        ...
        <div className="flex justify-end items-end mt-2">
          <div className="flex items-center justify-end max-w-lg gap-2 px-2 border-r-2 border-[#CB7474]">
            <div>
              <p className="text-sm bg-[#46417D] rounded-lg p-2 text-white mt-1">
                Lorem Ipsum is simply dummy text of the printing and typesetting
                industry. Lorem Ipsum is simply dummy
              </p>
